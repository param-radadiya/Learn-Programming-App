...
import com.example.libraries.SpaceTabLayout;
...
public class CppLanguage extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        gridAdapter2 = new GriadAdapter2(this,recyclerList2);
        ...
        recyclerView2.addOnItemTouchListener(new CLanguage.RecyclerTouchListener(getApplicationContext(), recyclerView, new CLanguage.ClickListener() {
            ...
            public void onClick(View view, int position) {
                switch (position) {
                    case 0:
                        Intent a1 = new Intent(CppLanguage.this, webview.class);
                        a1.putExtra("web", "https://www.programiz.com/cpp-programming/online-compiler/");
                        startActivity(a1);
                        break;
        ...
        recyclerView.addOnItemTouchListener(new CppLanguage.RecyclerTouchListener(getApplicationContext(), recyclerView, new CppLanguage.ClickListener() {

            @Override
            public void onClick(View view, int position) {
                switch (position) {
                    case 0:
                        startActivity(new Intent(CppLanguage.this, FragmentCA.class));
                        break;
                    case 1:
                        startActivity(new Intent(CppLanguage.this, FragmentCB.class));
                        break;
                    case 2:
                        startActivity(new Intent(CppLanguage.this, FragmentCC.class));
                        break;
                    case 3:
                        Intent a1 = new Intent(CppLanguage.this, webview.class);
                        a1.putExtra("web", "file:///android_asset/cpp/QueAns/cpp_interview_que_ans.html");
                        startActivity(a1);
                        break;
                }
    ...
    public static class RecyclerTouchListener implements RecyclerView.OnItemTouchListener {
        ...
        private CppLanguage.ClickListener clickListener;

        public RecyclerTouchListener(Context context, final RecyclerView recyclerView, final CppLanguage.ClickListener clickListener) {
